# Modified Wolf-Sheep-Grass Predation Model

## Modifications

This folder contains source code from the Mesa package's Wolf-Sheep predation model, as written by the Mesa development team, together with a Jupyter notebook written by Greg Tucker to demonstrate coupling between a Mesa ABM and a Landlab gridded numerical model.

The text below here is from the Mesa project's original README.md:
