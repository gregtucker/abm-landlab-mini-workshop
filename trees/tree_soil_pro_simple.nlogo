...
to setup-trees
  ...
  ask trees [ setxy random-xcor random-ycor set size 4 set shape "tree" set color lime set tree-age 1 set resources 1 ]
end
...
to resource-availability
  ask trees[
    ifelse any? trees in-radius 5
      [set resources (tree-age / (sum [tree-age] of trees in-radius 5))]
...
to seeds-germ
  ask seeds[
    ...
    if germinate >= seed-fecundity [
      hatch-trees 1 [ set size 5 set shape "tree" set color green set tree-age 1 set resources 1 ]
      die
    ]
    if germinate < seed-fecundity[
      die
...
"" ""
PENS
"trees" 1.0 0 -13840069 true "" "if any? trees [ plot mean [tree-age] of trees ]"
"soil" 1.0 0 -1184463 true "" "if any? soil [ plot mean [soil-age] of soil ]"
...
"" ""
PENS
"trees" 1.0 0 -13840069 true "" "plot count trees / (76 * 76)"
"soil" 1.0 0 -1184463 true "" "plot count soil / (76 * 76)"
